...
def generate_presigned_url(bucket_name: str, blob_name: str, write_only=False, expiration=3600) -> str:
    ...
    blob_url_with_sas = f"https://{storage_account_name}.blob.core.windows.net/{bucket_name}/{blob_name}?{sas_token}"

    return blob_url_with_sas


def check_blob_exist(bucket_name: str, blob_path: str) -> bool:
